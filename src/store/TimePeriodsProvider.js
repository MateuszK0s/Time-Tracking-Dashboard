...
import TimePeriodsContext from "./TimePeriodsContext";

const TimePeriodsProvider = (props) => {
  const onChangeTimePeriod = (props) => {
    setTimePeriods((prevState) => ({
      ...prevState,
      timePeriod: props,
    }));
  };
  ...
  return (
    <TimePeriodsContext.Provider value={timePeriods}>
      {props.children}
    </TimePeriodsContext.Provider>
  );
};

export default TimePeriodsProvider;
